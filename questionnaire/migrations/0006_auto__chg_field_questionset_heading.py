...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('questionnaire_questionset', 'heading', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'QuestionSet.heading'
        db.alter_column('questionnaire_questionset', 'heading', self.gf('django.db.models.fields.CharField')(max_length=250))
