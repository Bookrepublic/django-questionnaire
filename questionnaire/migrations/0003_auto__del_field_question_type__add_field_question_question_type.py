...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('questionnaire_question', 'type')

        # Adding field 'Question.question_type'
        db.add_column('questionnaire_question', 'question_type',
                      self.gf('django.db.models.fields.CharField')(default='text', max_length=32),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('questionnaire_question', 'question_type')
