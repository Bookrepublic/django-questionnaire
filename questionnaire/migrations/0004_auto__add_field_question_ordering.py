...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.ordering'
        db.add_column('questionnaire_question', 'ordering',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.ordering'
        db.delete_column('questionnaire_question', 'ordering')
