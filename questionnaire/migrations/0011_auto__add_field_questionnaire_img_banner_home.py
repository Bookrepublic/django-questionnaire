...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Questionnaire.img_banner_home'
        db.add_column('questionnaire_questionnaire', 'img_banner_home',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Questionnaire.img_banner_home'
        db.delete_column('questionnaire_questionnaire', 'img_banner_home')
    ...
    models = {
        ...
        'questionnaire.questionnaire': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'img_banner_home': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
