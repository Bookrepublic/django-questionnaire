...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Response.sessionid'
        db.add_column('questionnaire_response', 'sessionid',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Response.user'
        db.alter_column('questionnaire_response', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):
        # Deleting field 'Response.sessionid'
        db.delete_column('questionnaire_response', 'sessionid')


        # Changing field 'Response.user'
        db.alter_column('questionnaire_response', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
